...
train_folders = get_datafolders(train_filename);
test_folders = get_datafolders(test_filename);
...
valid_dataset = valid_dataset[0:10][:]
test_dataset = test_dataset[0:10000][:]

train_labels = train_labels[0:10][:]
valid_labels = valid_labels[0:10000][:]
...
print 'Accuracy : ', clf.score(test_dataset, test_labels);